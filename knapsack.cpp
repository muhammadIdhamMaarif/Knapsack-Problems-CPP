...
public:
    ...
    int solve(const std::string& method = "dp") override {
        ...
        if (method == "brute-force") return solveBruteForce(0, capacity);       // Brute-force rekursif
        if (method == "brute-force-bitmask") return solveBruteBitmask();        // Bitmasking
...
public:
    ...
    int solve(const std::string& algorithm = "greedy") override {
        ...
        if (algorithm == "brute-force") return solveBruteForce(0, capacity); // Brute-force rekursif (belum didefinisikan)
        if (algorithm == "brute-force-bitmask") return solveBitmaskFraction(); // Bitmasking (belum didefinisikan)
...
public:
    ...
    int solve(const std::string& algorithm = "dp") override {
        if (algorithm == "brute-force") return solveBruteForce(0, capacity);              // Eksplorasi semua kemungkinan jumlah item
        if (algorithm == "brute-force-bitmask") return solveBruteForceBitmask();          // Cek semua subset dari item hasil ekspansi
        ...
        switch (choice) {
            case 1: { // 0/1 Knapsack
                ...
                std::vector<std::string> algorithms = {
                    "dp", "dp-1d", "recursive-memo", "brute-force",
                    "brute-force-bitmask", "meet-in-the-middle",
                    "branch-and-bound", "fptas", "greedy-local", "drl"
                };
            ...
            case 2: { // Fractional Knapsack
                ...
                std::vector<std::string> algorithms = {
                    "greedy", "sort-then-fill", "brute-force", "brute-force-bitmask"
                };
            ...
            case 3: { // Bounded Knapsack
                ...
                std::vector<std::string> algorithms = {
                    ...
                    "brute-force", "brute-force-bitmask", 
            ...
            case 4: { // Unbounded Knapsack
                ...
                std::vector<std::string> algorithms = {"dp", "dp-1d", "recursive-memo", "brute-force"};
            ...
            case 5: { // Multi-Dimensional Knapsack
                ...
                std::vector<std::string> algorithms = {"dp", "recursive-memo", "brute-force"};
            ...
            case 6: { // Multi-Objective Knapsack
                ...
                std::vector<std::string> algorithms = {"dp", "brute-force", "lexicographic", "weighted-sum"};
            ...
            case 7: { // Multiple Knapsack
                ...
                std::vector<std::string> algorithms = {"dp-each-bag", "greedy", "brute-force"};
            ...
            case 8: { // Quadratic Knapsack
                ...
                std::vector<std::string> algorithms = {"brute-force", "greedy", "dp-approx"};
            ...
            case 10: { // Multiple-Choice Knapsack
                ...
                std::vector<std::string> algorithms = {"dp", "greedy", "brute-force"};
